...
\section{Description textuelle des cas d’utilisation}
  \input{project/use-cases/load-city-map_fr_FR.tex}
  \input{project/use-cases/load-delivery-request_fr_FR.tex}
  \input{project/use-cases/compute-planning_fr_FR.tex} 
...
\section{Diagramme de packages et de classes}
  ...
  \begin{figure}[h!]
    \begin{center}
      \includegraphics[width=\linewidth]{uml/packages-overview.png}
