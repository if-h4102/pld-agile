...
public class DeliveryRequestTest {
    ...
    public void equalsTest() {
        ...
        DeliveryRequest base = new DeliveryRequest(baseWarehouse, baseDeliveryAddresses, 36000);
        ...
        DeliveryRequest sameAsBase = new DeliveryRequest(sameAsBaseW, sameAsBaseDA, 36000);
        ...
        DeliveryRequest modifiedWarehouse = new DeliveryRequest(modifiedWarehouseW, modifiedWarehouseDA, 36000);
        ...
        DeliveryRequest modifiedDeliveryAddresses = new DeliveryRequest(modifiedDeliveryAddressesW, modifiedDeliveryAddressesDA, 36000);
        ...
        DeliveryRequest moreDeliveryAddresses = new DeliveryRequest(moreDeliveryAddressesW, moreDeliveryAddressesDA, 36000);
        ...
        DeliveryRequest modifiedStartTime = new DeliveryRequest(modifiedStartTimeW, modifiedStartTimeDA, 35000);
